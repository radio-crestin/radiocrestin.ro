export default function PrivacyPolicyPage() {
    return (
        <div className="max-w-4xl mx-auto my-12 p-10 bg-background-header text-foreground rounded-xl shadow-sm leading-relaxed [&_*]:text-foreground">
            <h1 className="text-4xl mb-6 text-primary">Privacy Policy</h1>
            ...
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Interpretation and Definitions</h2>
            <h3 className="text-2xl mt-6 mb-3">Interpretation</h3>
            ...
            <h3 className="text-2xl mt-6 mb-3">Definitions</h3>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Cauta versete in Biblie, the software program provided by
                        the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the
                        Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
                        Cauta versete in Biblie.</p>
                </li>
                <li>
            ...
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Collecting and Using Your Personal Data</h2>
            <h3 className="text-2xl mt-6 mb-3">Types of Data Collected</h3>
            <h4>Personal Data</h4>
            ...
            <h3 className="text-2xl mt-6 mb-3">Use of Your Personal Data</h3>
            ...
            <h3 className="text-2xl mt-6 mb-3">Retention of Your Personal Data</h3>
            ...
            <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
                ...
                periods.</p>
            <h3 className="text-2xl mt-6 mb-3">Transfer of Your Personal Data</h3>
            ...
            <h3 className="text-2xl mt-6 mb-3">Delete Your Personal Data</h3>
            ...
            <h3 className="text-2xl mt-6 mb-3">Disclosure of Your Personal Data</h3>
            ...
            <h3 className="text-2xl mt-6 mb-3">Security of Your Personal Data</h3>
            ...
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Children&apos;s Privacy</h2>
            ...
            <p>If We need to rely on consent as a legal basis for processing Your information and Your country requires
                ...
                information.</p>
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Links to Other Websites</h2>
            ...
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Changes to this Privacy Policy</h2>
            ...
            <h2 className="text-3xl mt-8 mb-4 pb-2 border-b-2 border-primary">Contact Us</h2>
